...
namespace AuditManagementPortalMVC.Controllers
{
    public class SeverityController : Controller
    {
        ...
        public SeverityController(IConfiguration _config)
        {
            config = _config;
        ...
        public AuditResponse Index(InternalQuestions questions,string Token)
        {
        ...
        public AuditResponse Index1(SOXQuestions questions,string Token)
        {
            AuditResponse auditResponse = new AuditResponse();
